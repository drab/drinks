module.exports = [
        {
            ...
            ingredients: [
                {
                    description: "⅓ oz. Campari"
                },
                {
                    description: "⅓ oz. gin"
                },
                {
                    description: "⅓ oz. sweet vermouth"
                },
                {
                    description: "Chilled prosecco, or other sparkling wine, for topping"
                },
                {
                    description: "Orange peel twist (optional)"
                }
            ]
        },
        {
            ...
            ingredients: [
                {
                    description: "½ oz. fresh lime juice"
                },
                {
                    description: "⅓ of a large jalapeño, sliced, plus more for garnish"
                },
                {
                    description: "1¾ oz. tequila"
                },
                {
                    description: "1½ oz. fresh pineapple juice"
                },
                {
                    description: "½ oz. Grand Marnier or other orange liqueur"
                },
                {
                    description: "Pineapple wedge and peel, for garnish"
                }
            ]
        }
    ]